...
export const restaurants: Restaurant[] = [
...

  {
    id: '8',
    name: 'Smoke2Snack',
    description: 'Disposables, eLiquids, Vape Kits, Pods, Vaporizers & Snacks — delivered fast',
    ...
    open: true,
    menu: [
      { id: 'v1', name: 'Elfbar BC5000 Bold', description: 'Disposable vape — Strawberry Kiwi, Grape Energy, Peach Berry & more. Buy 2 for $29.99', price: 19.99, popular: true, image: 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=400&auto=format&fit=crop' },
      { id: 'v2', name: 'Gcore G7000 J.F.', description: 'Premium disposable vape device', price: 17.99, popular: true, image: 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=400&auto=format&fit=crop' },
      { id: 'v3', name: 'Vaporesso XROS Pods', description: 'Replacement mesh pods 4-pack', price: 21.99, image: 'https://images.unsplash.com/photo-1512069772995-ec65ed45afd6?w=400&auto=format&fit=crop' },
      { id: 'v4', name: 'Uwell Caliburn G3 Pods', description: '4-pack replacement pods', price: 21.99, image: 'https://images.unsplash.com/photo-1512069772995-ec65ed45afd6?w=400&auto=format&fit=crop' },
      { id: 'v5', name: 'Backwoods Original (5pk)', description: 'Classic Backwoods cigars, pack of 5', price: 20.99, image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=400&auto=format&fit=crop' },
      { id: 'v6', name: 'Backwoods Rum (5pk)', description: 'Rum flavoured Backwoods cigars, pack of 5', price: 20.99, image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=400&auto=format&fit=crop' },
      { id: 'v7', name: 'Colts Original Single', description: 'Single Colts Original cigar', price: 2.69, image: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=400&auto=format&fit=crop' },
      { id: 'v8', name: 'Snickers Almond 49.9g', description: 'Classic Snickers with almond', price: 2.49, popular: true, image: 'https://images.unsplash.com/photo-1548907040-4baa42d10919?w=400&auto=format&fit=crop' },
      { id: 'v9', name: 'Reeses White 39g', description: "White chocolate Reese's peanut butter cup", price: 1.99, image: 'https://images.unsplash.com/photo-1548907040-4baa42d10919?w=400&auto=format&fit=crop' },
      { id: 'v10', name: 'KitKat Chunky Choco 42g', description: 'Chunky KitKat chocolate extreme', price: 3.99, image: 'https://images.unsplash.com/photo-1548907040-4baa42d10919?w=400&auto=format&fit=crop' },
      { id: 'v11', name: 'MrBeast Bar', description: 'Feastables MrBeast chocolate bar — Almond, Sea Salt, or Original', price: 4.99, popular: true, image: 'https://images.unsplash.com/photo-1548907040-4baa42d10919?w=400&auto=format&fit=crop' },
      { id: 'v12', name: 'Meiji Hello Panda 198g', description: 'Chocolate cream filled panda cookies', price: 9.99, image: 'https://images.unsplash.com/photo-1548907040-4baa42d10919?w=400&auto=format&fit=crop' },
    ]
  },
];
