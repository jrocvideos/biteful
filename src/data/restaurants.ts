...
export const restaurants: Restaurant[] = [
...

  {
    ...
    open: true,
    menu: [
      { id: 'v1', name: 'Disposable Vape', description: 'Lost Mary, BC5000, Elf Bar & more — ask driver for available flavours', price: 19.99, popular: true },
      { id: 'v2', name: 'E-Liquid 30ml', description: 'Premium e-juice in various nicotine levels and flavours', price: 14.99, popular: true },
      { id: 'v3', name: 'Vape Kit (Starter)', description: 'Device + coil bundle, great for beginners', price: 34.99 },
      { id: 'v4', name: 'Pods Pack', description: 'Compatible replacement pods, assorted flavours', price: 24.99 },
      { id: 'v5', name: 'Vaporizer', description: 'Dry herb and concentrate vaporizers', price: 49.99 },
      { id: 'v6', name: 'Vape Accessories', description: 'Coils, chargers, cases and more', price: 9.99 },
      { id: 'v7', name: 'Snack Bundle', description: 'Chips, candy, energy drink — the essentials', price: 12.99, popular: true },
      { id: 'v8', name: 'Gear', description: 'Apparel, lighters, and smoking accessories', price: 14.99 },
    ]
  },
];
