...
const initialJobs: DeliveryJob[] = [
  {
    ...
    restaurantAddress: '128 W 45th St, New York, NY',
    customer: 'Alex M.',
    customerAddress: '245 E 45th St, Apt 12B, New York, NY',
    distance: '0.4 mi',
    earnings: 8.50,
    tip: 4.00,
  ...
  },
  {
    ...
    restaurantAddress: '890 3rd Ave, New York, NY',
    customer: 'Sarah K.',
    customerAddress: '450 Lexington Ave, Floor 8, New York, NY',
    distance: '1.2 mi',
    earnings: 12.75,
    tip: 6.50,
  ...
  },
  {
    ...
    restaurantAddress: '56 Mulberry St, New York, NY',
    customer: 'Mike R.',
    customerAddress: '156 W 28th St, Apt 3C, New York, NY',
    distance: '0.8 mi',
    earnings: 9.25,
    tip: 3.00,
...
const completedJobs: DeliveryJob[] = [
  {
    ...
    restaurantAddress: '200 Park Ave, New York, NY',
    customer: 'Jessica L.',
    customerAddress: '350 5th Ave, New York, NY',
    distance: '0.6 mi',
    earnings: 7.00,
    tip: 5.00,
  ...
  },
  {
    ...
    restaurantAddress: '89 Canal St, New York, NY',
    customer: 'David W.',
    customerAddress: '77 Bowery, Apt 5A, New York, NY',
    distance: '1.1 mi',
    earnings: 10.50,
    tip: 2.50,
