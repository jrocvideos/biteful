...
{ id: 'driving_to_restaurant', label: 'Driving to Restaurant', icon: Bike, description: 'Driver is heading to the restaurant' },
  ...
  { id: 'arriving', label: 'Driver Arrived', icon: MapPin, description: 'Driver has reached your address' },
...
export const OrderTracking = () => {
  ...
  useEffect(() => {
    ...
    const socket = io('https://boufet-backend-production-e170.up.railway.app', { transports: ['websocket', 'polling'] });
    socket.on('connect', () => {
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-card rounded-2xl border border-border p-6">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between"><span className="text-muted-foreground">Service Fee</span><span>${sf((orderData?.adminFee || orderData?.serviceFee || 0))}</span></div>
