...
const initialRestaurants: Restaurant[] = [
  { id: '1', name: 'Provence Marinaside', ownerName: 'Marc Dupont', phone: '(604) 681-4144', email: 'marc@provence.ca', address: '1177 Marinaside Cr, Yaletown', cuisine: 'French', status: 'meeting_booked', followUpDate: '2026-05-08', notes: 'Owner very interested. Frustrated with DoorDash fees. Meeting Tuesday 2pm.', avgMonthlyOrders: 800, dateAdded: '2026-05-04' },
  { id: '2', name: 'The Keg Yaletown', ownerName: 'Sandra Li', phone: '(604) 685-4388', email: 'sandra@kegyaletown.ca', address: '1011 Mainland St, Yaletown', cuisine: 'Steakhouse', status: 'contacted', followUpDate: '2026-05-07', notes: 'Left message. Follow up Wednesday morning.', avgMonthlyOrders: 1200, dateAdded: '2026-05-04' },
  { id: '3', name: 'Blue Water Cafe', ownerName: 'James Olson', phone: '(604) 688-8078', email: 'james@bluewatercafe.net', address: '1095 Hamilton St, Yaletown', cuisine: 'Seafood', status: 'signed', followUpDate: '', notes: 'SIGNED! 20% commission. Goes live May 10.', avgMonthlyOrders: 950, dateAdded: '2026-05-03' },
  { id: '4', name: 'Minami Restaurant', ownerName: 'Aki Tanaka', phone: '(604) 685-8080', email: 'aki@minamirestaurant.com', address: '1118 Mainland St, Yaletown', cuisine: 'Japanese', status: 'contacted', followUpDate: '2026-05-09', notes: 'Receptionist took info. Owner unavailable. Try again Friday.', avgMonthlyOrders: 700, dateAdded: '2026-05-04' },
  { id: '5', name: 'Tap & Barrel Olympic', ownerName: 'Kevin Park', phone: '(604) 648-2227', email: 'kevin@tapandbarrel.ca', address: '1 Athletes Way, Olympic Village', cuisine: 'Pub', status: 'declined', followUpDate: '', notes: 'Locked into DoorDash 2-year contract. Revisit Nov 2026.', avgMonthlyOrders: 600, dateAdded: '2026-05-02' },
  { id: '6', name: 'Craft Beer Market', ownerName: 'Tanya Ross', phone: '(604) 709-2337', email: 'tanya@craftbeermarket.ca', address: '85 W 1st Ave, Olympic Village', cuisine: 'Pub/American', status: 'meeting_booked', followUpDate: '2026-05-06', notes: 'GM very receptive. Wants comparison sheet. Send before meeting.', avgMonthlyOrders: 1100, dateAdded: '2026-05-03' },
];
